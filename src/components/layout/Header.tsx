...
function Header({ locale }: ILocale) {
  return (
    <div className="ltr w-full space-y-10 rounded-b-full bg-code-pattern bg-top pb-24 pt-4 shadow-2xl shadow-slate-600 500:rounded-b-[70%]">
      ...
      <span className="animate-profilePicDown flex justify-center">
        <Image
          ...
          height={200}
          priority
          className="mt-5 size-[11rem] rounded-[100%] border-2 border-solid border-white shadow-lg shadow-slate-400"
        />
      </span>
